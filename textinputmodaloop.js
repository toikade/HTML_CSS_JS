proto={
	...
	checkCounter:0,
	checkedSubjects:[],
	checkedSubjectPeriods:{},
	checkedSubjectsData:{},
	checkedSubjectTeachers:{},
	...
	setCheckboxes(checkedSubjectsArray, addedSubject){
			...
			this.$('#button__addsubject_to_setsubjects').detach();
			if(this.$('#weeklysubjectperiodmodal')){
				this.$('#weeklysubjectperiodmodal').attr('id', 'subjectmodal');
			}
		let subjectNumber=1;
	...
	makeBodyDivForClassTimeTable(){
		...
		<form method="get" autocomp  lete="off" id="inputmodal" style="text-align:center;">
	...
	$('#button__add_class').on('click', function(){
			makeBodyDivForClassTimeTable();
	});
	...
	makeModal(fieldsetId="setclassroommodal", legendId="classroom_name", modaltitleBar="New subject", formId="inputmodal", textPlaceholder="Subject", buttonId="submitNewSubject", buttonValue="Submit"){
